 ...
 */
package com.example.lvanims_core;
...
import com.example.lvanims_core.util.AbsListViewWrapper;
import com.example.lvanims_core.util.Insertable;
import com.example.lvanims_core.util.ListViewWrapper;
import com.example.lvanims_core.util.ListViewWrapperSetter;
import com.example.lvanims_core.util.Swappable;
...
public abstract class BaseAdapterDecorator extends BaseAdapter implements SectionIndexer, Swappable, Insertable, ListViewWrapperSetter {
    ...
    /**
     * The {@link com.example.lvanims_core.util.ListViewWrapper} containing the ListView this {@code BaseAdapterDecorator} will be bound to.
     */
    @Nullable
    ...
    /**
     * Returns the {@link com.example.lvanims_core.util.ListViewWrapper} containing the ListView this {@code BaseAdapterDecorator} is bound to.
     */
    @Nullable
    ...
    /**
     * Alternative to {@link #setAbsListView(AbsListView)}. Sets the {@link com.example.lvanims_core.util.ListViewWrapper} which contains the ListView
